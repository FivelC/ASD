...
#include "../lib_unsortedtablelist/unsortedtablelist.h"
#include "../lib_polynom/polynom.h"
TEST(UnsortedTableListTest, InsertFindSize) {
...
TEST(UnsortedTableListTest, ChangeVal) {
	UnsortedTable<std::string, Polynom> table;
...
TEST(UnsortedTableListTest, ChangeKey) {
	UnsortedTable<std::string, Polynom> table;
...
TEST(UnsortedTableListTest, Remove) {
	UnsortedTable<std::string, Polynom> table;
...
TEST(UnsortedTableListTest, IsEmpty) {
	UnsortedTable<std::string, Polynom> table;
	Polynom p1("2x^2 + 3z");
	Polynom p2("3x^3");
